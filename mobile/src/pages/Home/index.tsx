        ...
        >
            ...
            >
                ...
                <View style={styles.footer}>
                    <RNPickerSelect
                        onValueChange={(ufPicker) => setUfSelecionada(ufPicker)}
                        placeholder={{
                    ...
                    />
                    <RNPickerSelect
                        onValueChange={(cidadePicker) => setCidadeSelecionada(cidadePicker)}
                        placeholder={{
                    ...
                    />
                    <RectButton style={styles.button} onPress={navegarParaPontos}>
